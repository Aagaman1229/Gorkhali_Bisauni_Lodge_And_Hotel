-- ============================================
-- Gorkhali Bisauni Lodge And Hotel - COMPLETE SCHEMA
-- Run this in Supabase SQL Editor (drop all old tables first to avoid conflicts)
-- ============================================
...
BEGIN
  ...
  nights := GREATEST((NEW.check_out - NEW.check_in), 1);
